...
import { responsiveHeight, responsiveWidth, scaleFont } from '../utils/responsive';
import { FONTS, COLORS, colors } from '../utils/constants';
import { Iconify } from 'react-native-iconify';

const WeightList = ({ item, index, toggleAccordion, handleModal, isOpen, bgColor }) => {
            ...
            <TouchableOpacity onPress={toggleAccordion} style={[styles.contentCard,{backgroundColor:COLORS.WHITE}]}>
                ...
                {isOpen && (
                    <View style={{ gap: 8, marginTop: 10 }}>
                        ...
                        {renderInfo('Metal Name', item.metal_name)}
